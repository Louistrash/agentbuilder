...
import { Users, SendHorizontal, Lock, Bot, ShoppingBag } from "lucide-react";
        ...
        <div className="space-y-8">
          ...
          >
            <div className="bg-[#161B22] rounded-xl border border-[#30363D] p-4">
              <TabsList className="bg-[#1C2128] border border-[#30363D] w-full sm:w-auto grid grid-cols-2 sm:inline-grid">
                <TabsTrigger 
                  value="agents" 
                  className="text-white data-[state=active]:bg-[#30363D]"
                >
            ...
            <TabsContent value="addons" className="mt-0">
              <div className="bg-[#161B22] rounded-xl border border-[#30363D] overflow-hidden">
                <div className="border-b border-[#30363D] bg-[#1C2128] p-4 flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-white">Add-ons Marketplace</h2>
                </div>
                <div className="p-6">
                  <AddonsMarketplace />
                </div>
