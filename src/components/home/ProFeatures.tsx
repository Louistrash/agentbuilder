...
export function ProFeatures() {
  ...
  return <div className="mt-16 sm:mt-24 px-4 sm:px-0">
      ...
      <Card className="p-4 sm:p-8 border border-[#1EAEDB]/10 rounded-2xl overflow-hidden relative bg-gray-950">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start relative z-10">
          <div className="space-y-6">
            ...
            <Button onClick={() => navigate('/auth?plan=pro')} className="w-full sm:w-auto bg-[#1EAEDB] hover:bg-[#0FA0CE] text-white transition-all duration-300">
          ...
          <div className="space-y-6">
              ...
              <div className="h-[140px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={data}>
                    ...
                    <Area type="monotone" dataKey="engagement" stroke="#1EAEDB" fill="url(#colorEngagement)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div className="p-4 rounded-xl bg-black/40 border border-[#1EAEDB]/10" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
