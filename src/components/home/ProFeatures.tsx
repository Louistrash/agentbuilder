...
export function ProFeatures() {
  ...
  return (
    <div className="mt-16 sm:mt-24 px-4 sm:px-0 text-center">
      ...
      <Card className="p-4 sm:p-8 bg-white/5 backdrop-blur-sm border border-white/10">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="text-left">
            ...
            <Button 
              ...
              className="w-full sm:w-auto bg-white text-gray-900 hover:bg-gray-200"
            >
